(function($) {
    ...
    $.fn.simpleCropper = function(onComplete) {
        ...
        var jcrop_api;
        var bottom_html = "<input type='file' id='fileInput' name='files[]'/ accept='image/*'><canvas id='myCanvas' style='display:none; width:1024px; height:800px; position:relative'></canvas><div id='modal'></div><div id='preview'><div class='buttons'><div class='ok'></div></div></div>";
